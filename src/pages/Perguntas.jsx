...
const perguntas = [
  ...
  },
  {
    ...
    summary: 'Carlos e Márcia não sabem o que não sabem. Acham que para lucrar mais precisam vender mais — mas a maior oportunidade está em otimizar o que já têm. O prato mais pedido pode ser o que menos lucra. O delivery pode estar destruindo a margem do salão. 12 meses de dados organizados valem crédito com juros 40% menores. O negócio que parece "pequeno demais" pode ser franqueável. Nenhuma dessas oportunidades é visível sem dados — e é exatamente aí que a Tamy entra.',
    items: [
      ...
      ['Aprendem gestão financeira no próprio negócio, sem faculdade — o dado educa melhor que qualquer curso', 'post', 'Post Pedro'],
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          ['IA vai atrás do dono (proativa via WhatsApp), não espera ele lembrar de abrir o app', 'post', 'Post'],
        ],
      },
      {
  ...
  },
  {
    ...
    summary: 'Q12 conecta tudo: cada pergunta é um pilar editorial autônomo, cada dor mapeia para uma feature, e o tom da marca muda por tipo de conteúdo. Pedro é a voz porque é a persona que virou founder. Márcia é a persona invisível — 52,7% do setor é mulher, mas quase nenhum conteúdo de gestão fala com ela. O diferencial não é tecnologia — é que nenhum concorrente BR tem copilot chat + DRE tempo real + proatividade + 79 skills financeiras.',
    items: [
      ...
      ['Diferencial competitivo real: Saipos (25k clientes, iFood dono desde Abr 2025) sem AI-first, UX datada. Simpliza freemium sem profundidade. Sischef genérico sem inovação. Nenhum tem copilot chat + DRE tempo real + proatividade + 79 skills food service', 'artigo', 'Comparativo'],
      ['Modelo Toast+Ramp+Restoke+Duolingo: Ramp = "economizamos pra você" (não só reporta), Duolingo = streak + hábito, Toast = SaaS → fintech, Restoke = ROI quantificável ($8K/semana), F360 = reconciliação multi-canal BR', 'artigo', 'Artigo'],
